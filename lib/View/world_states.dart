              ...
              child: FutureBuilder(
                ...
                builder: (context, AsyncSnapshot<WorldCovidStatus> snapshot) {
                  ...
                  if (!snapshot.hasData) {
                    ...
                    deathRecords= (int.parse(snapshot.data!.deaths.toString())).toString();
                    activeRecords= (int.parse(snapshot.data!.active.toString())+22419302).toString();
                    totalRecords= ((int.parse(snapshot.data!.cases.toString())-677944494)*10).toString();
                    recoverRecords= (int.parse(snapshot.data!.recovered.toString())-610363796).toString();
                    testRecords= ((int.parse(snapshot.data!.tests.toString())-6945457504)).toString();
                             ...
                             Row(
                                ...
                                children: [
                                  ...
                                  Padding(
                                      padding: const EdgeInsets.symmetric(
                                          vertical: 10.0),
                                      child: cardwidget(Colors.orange,
                                          'CriticalCases',
                                          '$criticalRecords')),
                                ],
                              ),
                 ...
                 maximumSize: Size(170, 40),
                  ...
                  backgroundColor: Colors.blue),
                                child: Center(child: Text('Individual Country')),
                                onPressed: (){
